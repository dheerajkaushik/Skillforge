...
import com.skillforge.runner.RunnerResult; // ✅ Matches your RunnerResult location
import org.springframework.stereotype.Service;
import org.springframework.util.FileSystemUtils;
...
public class RunnerService {
    ...
    public RunnerResult runJava(String sourceCode, String input) {
        ...
        try {
            ...
            // Run (Memory Optimized)
            ProcessBuilder runBuilder = new ProcessBuilder("java", "-Xmx32m", "-Xms16m", "Main");
            runBuilder.directory(dir);
            Process run = runBuilder.start();
